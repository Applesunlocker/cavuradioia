  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Stream not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          The page you're looking for has gone offline.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something interrupted the stream. Try again or head home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CavuStream AI — Live streaming reimagined" },
      { name: "description", content: "Professional live streaming studio powered by AI. Multistream, auto-clip, and broadcast like a pro." },
      { property: "og:title", content: "CavuStream AI — Live streaming reimagined" },
      { property: "og:description", content: "Professional live streaming studio powered by AI. Multistream, auto-clip, and broadcast like a pro." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CavuStream AI — Live streaming reimagined" },
      { name: "twitter:description", content: "Professional live streaming studio powered by AI. Multistream, auto-clip, and broadcast like a pro." },
