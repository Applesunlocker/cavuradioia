...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NovaStream AI — Live streaming reimagined" },
      { name: "description", content: "Professional live streaming studio powered by AI. Multistream, auto-clip, and broadcast like a pro." },
      { property: "og:title", content: "NovaStream AI" },
      { property: "og:description", content: "Professional live streaming studio powered by AI." },
